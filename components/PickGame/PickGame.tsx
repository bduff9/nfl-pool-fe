...
import type { LoadingType } from "../../pages/picks/set";
    ...
    >
      <div className="col-3 col-md-2 d-flex align-items-center justify-content-end">
        <Point
          ...
          isDropDisabled={
            hasMadePick && dragGameID !== `pick-for-game-${pick.game.gameID}`
          }
          maxValue={gameCount}
          value={
      ...
      <div className="col-3 col-md-2 d-flex align-items-center justify-content-start">
        <Point
          ...
          maxValue={gameCount}
          value={
            pick.team?.teamID === pick.game.homeTeam.teamID ? pick.pickPoints ?? 0 : 0
          }
        />
      </div>
    </div>
