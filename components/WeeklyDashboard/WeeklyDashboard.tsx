...
const WeeklyDashboard: FC = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="mb-0">Week {selectedWeek > 0 && selectedWeek} Rank</h2>
      {!data ? (
      ...
      {data?.getMyWeeklyDashboard && (
        <div>
          ...
          <h2 className={clsx("mt-5", styles["weekly-results"])}>
            My Week {selectedWeek} Results
          </h2>
          <ProgressChart
